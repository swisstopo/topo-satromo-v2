...
1. **Select collection in the STAC Browser**  
   Open for `SwissEO S2-SR` [https://data.geo.admin.ch/browser/index.html#/collections/ch.swisstopo.swisseo_s2-sr_v200](https://data.geo.admin.ch/browser/index.html#/collections/ch.swisstopo.swisseo_s2-sr_v200) respectively for `SwissEO VHI` [https://data.geo.admin.ch/browser/index.html#/collections/ch.swisstopo.swisseo_vhi_v200](https://data.geo.admin.ch/browser/index.html#/collections/ch.swisstopo.swisseo_vhi_v200).
...
4. **Retrieve Cloud Optimized GeoTIFF (COG)**  
   - Right-click on the desired asset link   
