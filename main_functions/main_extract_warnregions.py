    ...
    with rasterio.open(raster_url) as src:
        ...
        for idx, row in gdf.iterrows():
            ...
            try:
                ...
                # polygon genuinely doesn't overlap the raster
            ...
            if valid_values_count == 0:
                # region intersects the raster, but every pixel is masked/nodata this day
                raster_values.append(missing_values)      # or np.nan, your call on the mean-field convention
                availability_percentages.append(0.0)
                continue
            ...
            availability_percentage_rounded = round((valid_values_count / total_cells) * 100, 1)
            ...
            # print(f" Percentage of availability: {availability_percentage_rounded:.1f}%")
