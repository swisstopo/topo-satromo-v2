...
product_name = config_PRODUCT_VHI['product_name']
...
# Paths
stac_swisstopo, s2_sr_collection_id = config_PRODUCT_VHI['step0_collection'].split('#/collections/')
...
# Time window
d = int(config_PRODUCT_VHI['temporal_coverage'])-1
...
s3_path_ndvi_ref = f'{config_PRODUCT_VHI['NDVI_reference_data']}NDVI_Stats_DOY{doy_str}.tif'
...
if current_date < datetime(2024, 1, 1):
    sdl_path = f'{config_PRODUCT_VHI['LST_current_data']}/MSG2004-2023/msg.SDL.H_ch02.lonlat_{year}{month}01000000.nc'
    sol_path = f'{config_PRODUCT_VHI['LST_current_data']}/MSG2004-2023/msg.SOL.H_ch02.lonlat_{year}{month}01000000.nc'
elif current_date >= datetime(2024, 1, 1) and current_date < datetime(2026, 2, 1):
    sdl_path = f'{config_PRODUCT_VHI['LST_current_data']}/MSG2024-2026/msg.SDL.H_ch02.lonlat_{year}{month}01000000.nc'
    sol_path = f'{config_PRODUCT_VHI['LST_current_data']}/MSG2024-2026/msg.SOL.H_ch02.lonlat_{year}{month}01000000.nc'
else:
    sdl_path = f'{config_PRODUCT_VHI['LST_current_data']}/msg.SDL.H_ch02.lonlat_{year}{month}{day}000000.nc'
    sol_path = f'{config_PRODUCT_VHI['LST_current_data']}/msg.SOL.H_ch02.lonlat_{year}{month}{day}000000.nc'
...
s3_path_lst_ref = f'{config_PRODUCT_VHI['LST_reference_data']}LST_statistics_DOY{doy_str}{lst_ref_file}.nc'
...
#     filename = config_PRODUCT_VHI['product_name'] + \
#         '_mosaic_' + timestamp + '_vegetation-10m'
#     main_utils.prepare_export(roi, timestamp, filename, config_PRODUCT_VHI['product_name'],
#                             config_PRODUCT_VHI['spatial_scale_export'], vhi_vegetation,
...
#     main_utils.prepare_export(roi, timestamp, filename, config_PRODUCT_VHI['product_name'],
#                             config_PRODUCT_VHI['spatial_scale_export'], vhi_forest,
#                             sensor_stats, current_date_str)
